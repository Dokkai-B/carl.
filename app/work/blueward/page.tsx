...
const projectData: ProjectData = {
  ...
  role: "",
  summary:
    "A full emergency assistance platform with live bidirectional communication, geolocation tracking, remote media capture, and a multi-service cloud architecture. Blue Ward provides real-time emergency response coordination with advanced features for emergency personnel and civilians.",
  ...
  features: [
    { icon: Radio, text: "Real-time bidirectional communication with Socket.IO" },
    {
      icon: MapPin,
      text: "Live geolocation tracking with continuous GPS updates",
    },
    { icon: Camera, text: "Remote camera and audio capture for emergency assessment" },
    { icon: Battery, text: "Battery status monitoring for emergency device management" },
    { icon: Shield, text: "Secure cloud storage with AWS S3 integration" },
    { icon: Zap, text: "Multi-service architecture with Docker containerization" },
  ],
  techStack: [
    "React",
    "Flutter",
      ...
      {images.length > 1 && (
        <>
          <motion.button
            ...
            className="absolute left-6 z-20 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-200"
            style={{
              backgroundColor: "rgba(255, 255, 255, 0.1)",
              backdropFilter: "blur(12px)",
              WebkitBackdropFilter: "blur(12px)",
          ...
          <motion.button
            ...
            className="absolute right-6 z-20 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-200"
            style={{
              backgroundColor: "rgba(255, 255, 255, 0.1)",
              backdropFilter: "blur(12px)",
              WebkitBackdropFilter: "blur(12px)",
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto mb-32">
          ...
          {/* Desktop Mockups Section - BEFORE Mobile */}
          <div className="mb-24 py-16">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-4">
                <Monitor className="w-6 h-6" style={{ color: projectData.orbColors.primary }} />
                <h2
          ...
          <div className="mb-24 py-16">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-4">
                <Smartphone className="w-6 h-6" style={{ color: projectData.orbColors.primary }} />
                <h2
                  className="text-3xl md:text-4xl font-bold"
                  style={{
                    color: isDark ? "rgba(255,255,255,0.95)" : "rgba(31, 41, 55, 0.95)",
            ...
            >
              {/* Display 3 phones in 3D perspective */}
              <PhoneMockup
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="flex justify-between items-center pt-16 border-t"
            style={{
