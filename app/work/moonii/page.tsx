...
const projectData: ProjectData = {
  ...
  features: [
    { icon: Mic, text: "Record personalized audio stories with mobile-native microphone access" },
    {
      icon: Cloud,
      text: "Upload and store audio files securely using AWS S3 with pre-signed URLs",
    },
    { icon: Music, text: "High-quality AAC-LC encoded M4A audio format for optimized playback" },
    { icon: Play, text: "Modern audio player with waveform visualization and timeline controls" },
    { icon: Shield, text: "Playlist management and multi-view synchronized playback state" },
    { icon: Zap, text: "Error handling for failed uploads, network issues, and corrupted audio" },
  ],
  techStack: [
    "Flutter",
    "Node.js",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* REDESIGNED: Progress bar closer (-bottom-8) with purple theme and instant hover */}
        <motion.div
      ...
      <div ref={containerRef} className="min-h-screen relative">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-[120px] py-24">
          ...
          <div className="mb-24 py-16">
            ...
            >
              {/* LEFT phone - Recording (3D tilted toward center with overlap) */}
              <PhoneMockup
              ...
              {/* CENTER phone - Home (larger, faces forward, highest z-index) */}
              <PhoneMockup
              ...
              {/* RIGHT phone - Upload (3D tilted toward center with overlap) */}
              <PhoneMockup
                src={projectData.gallery[4].image}
                alt={`${projectData.title} — ${projectData.gallery[4].name}`}
                index={2}
