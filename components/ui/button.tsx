...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      default:
        "bg-gradient-to-r from-accent to-accent-hover text-primary shadow-[0_2px_6px_rgba(0,0,0,0.15)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.2)] hover:brightness-110",
      primary:
        "bg-gradient-to-r from-primary to-primary/80 text-white shadow-[0_2px_6px_rgba(0,0,0,0.15)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.2)]",
      outline:
      ...
      glass:
        "bg-white/[0.06] backdrop-blur-md border border-white/10 text-foreground shadow-[0_2px_8px_rgba(0,0,0,0.1)] hover:bg-white/[0.1] hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]",
    },
    size: {
